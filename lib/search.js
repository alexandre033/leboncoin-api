...
module.exports = class Search {
  ...
  init(options) {
    ...
    if (options.searchAttributes && options.searchExtras instanceof Search) {
    }
  ...
  getSubCategoriesExtras(currentCategoryId, searchExtras) {
